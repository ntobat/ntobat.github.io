$(function(){
  ...
  $('.picHover').on("mouseover", function() {
  	var picNum = $(this).data('picNum');
    $('#picHover' + picNum).hide();
    $('#gifHover' + picNum).removeClass('hidden');
  });

  $('.gifHover').on("mouseout", function() {
  	var gifNum = $(this).data('gifNum');
    $('#picHover' + gifNum).show();
    $('#gifHover' + gifNum).hide();
  });
